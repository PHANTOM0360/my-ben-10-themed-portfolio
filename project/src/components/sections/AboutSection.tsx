      ...
      <div className="flex flex-col md:flex-row gap-8">
        {imageUrl && (
          <div className="flex-shrink-0">
            <div className={`w-58 h-48 rounded-xl overflow-hidden border-2 ${gwenTheme ? 'border-pink-400 shadow-gwen-glow' : 'border-omnitrix-green-400 shadow-omnitrix-glow'}`}>
              <img 
                src={imageUrl} 
                alt={name} 
        ...
        <div className="flex-grow">
          ...
          <p className={`text-xl ${gwenTheme ? 'text-pink-300' : 'text-omnitrix-green-300'} mb-4 ${textClass}`}>{title}</p>
