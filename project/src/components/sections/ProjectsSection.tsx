    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {projects.map((project, index) => (
          <motion.div 
            key={project.id}
            className={`${gwenTheme ? 'bg-pink-950' : 'bg-omnitrix-black-800'} rounded-lg overflow-hidden border ${
              gwenTheme 
          ...
          >
            ...
            <div className="p-4">
              <h3 className={`text-xl font-bold ${gwenTheme ? 'text-pink-400' : 'text-omnitrix-green-400'} mb-2 ${textClass}`}>
                {project.title}
              </h3>
